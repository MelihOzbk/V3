...
public class RobotContainer {
  ...
  GenericEntry ampShootspeed = Shuffleboard.getTab("Speed").add("AS-Speed", 0.4).withWidget(BuiltInWidgets.kNumberBar)
      .getEntry();
  ...
  GenericEntry ampsliderspeed = Shuffleboard.getTab("Speed").add("AL-Speed", 0.4).withWidget(BuiltInWidgets.kNumberBar)
      .getEntry();
  ...
  GenericEntry elevatorSpeed = Shuffleboard.getTab("Speed").add("E-Speed", 0.5).withWidget(BuiltInWidgets.kNumberBar)
      .getEntry();
  ...
  public void configureBindings() {
    ...
    j_Driver.button(2)
        .whileTrue(
            m_shooter.speakerShoot(() -> speakerShootspeed.getDouble(0.8))
                .alongWith(m_intake.runSlider(() -> speakersliderspeed.getDouble(0.4))));
    ...
    j_Driver.button(3)
        .whileTrue(m_shooter.ampShoot(() -> ampShootspeed.getDouble(0.4))
    ...
    j_Driver.button(4).whileTrue(m_elevator.moveElevator(() -> elevatorSpeed.getDouble(0.5)));
